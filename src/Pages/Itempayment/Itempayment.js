...
import '../Itempayment/Itempayment.css'
  ...
  return (
    ...
    <div className='smallscreen-shippingmethod'>
        ...
        <div className='subheading-shippingmethod'>
            <div >DELIVERY</div>
            <div className='deliv-excep-shippingmethod'>PAYMENT</div>
            <div>SUMMARY</div>
        </div>
        ...
        <section className='section-twos-shippingmethod'>
                    ...
                    <div className='inner-checkout-right-lower-shippingmethod'>
                        <h5>NEED HELP ?</h5>
                        <p>Contact an expert to support you</p>
                       

                    </div>
                    <div className='footer-shippingmethod'>
